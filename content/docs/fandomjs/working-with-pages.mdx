...
console.log(images[0].title, images[0].url);
```
- `Page.images` fetches all images used on the page and returns an array of objects containing the image title, the URL and metadata.